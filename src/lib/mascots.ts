...
const mascotMap: Record<string, MascotInfo> = {
  ...
  economics: {
    ...
    bio: "EcoMax sees supply and demand in everything! From micro to macro, he'll help you understand how economies work with real-world examples.",
  ...
  "english-literature": {
    ...
    bio: "LitBug devours books and poetry alike. She'll help you analyse texts with precision, embed quotations seamlessly, and write essays that examiners love.",
  ...
  psychology: {
    ...
    bio: "PsyQ is fascinated by why people think, feel, and behave the way they do. From Milgram to memory models, he makes psychology engaging and exam-ready.",
  ...
  geography: {
    ...
    bio: "GeoX has explored every continent! She helps you understand physical and human geography through case studies, data analysis, and spatial thinking.",
  ...
  "business-studies": {
    ...
    bio: "BizBot thinks like a CEO! From break-even analysis to marketing strategy, he'll help you apply business theory to real-world scenarios and nail those exam essays.",
