...
export const PACKS: Record<string, QuestionPack> = {
  standard: {
    ...
    regional: {
      ...
      fr: { price: "€14.99", price_id: "price_1U3wLUFFogsDQVs4xvBnXg8K" },
      ph: { price: "₱899", price_id: "price_1U4zEsFFogsDQVs4YqJFAlH8" },
      de: { price: "€14.99", price_id: "price_1U3wLUFFogsDQVs4xvBnXg8K" },
    },
  },
  topup: {
    name: "Top-Up Pack",
    ...
    regional: {
      ...
      fr: { price: "€4.99", price_id: "price_1U3yIyFFogsDQVs4fUYgEjq2" },
      ph: { price: "₱299", price_id: "price_1U4zF6FFogsDQVs44UX0jPq5" },
      de: { price: "€4.99", price_id: "price_1U3yIyFFogsDQVs4fUYgEjq2" },
    },
  },
} as const;
