...
const navItems: NavItem[] = [
  ...
  { to: "/institution", label: "My Institution", icon: Building2, group: "classes", variant: "purple" },
  { to: "/join-institution", label: "Join Institution", icon: Building2, group: "classes", variant: "purple" },
